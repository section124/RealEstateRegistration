...
$query = "SELECT ApplicationID, UnitAddress, ApplicationDate FROM notarypublic WHERE FinalApproval != 'Accepted'";
$result = $link->query($query);

$queryAccepted = "SELECT ApplicationID, UnitAddress, ApplicationDate FROM notarypublic WHERE FinalApproval = 'Accepted'";
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <h2>Welcome to Notary Public Office<h2>
            <h2>Customer List</h2>
            <table class="table">
                <thead>
                    <tr>
        ...
        <script>
            function viewApplication(applicationID) {
                window.location.href = "ViewApplication(NP-A).php?applicationID=" + applicationID;
            }

            function changeStatus(applicationID) {
                window.location.href = "ChangeStatus(NP-A).php?applicationID=" + applicationID;
            }

            function viewStatus(applicationID) {
                window.location.href = "ViewStatus(NP-A).php?applicationID=" + applicationID;
            }
        </script>
        <!-- Template Javascript -->
